...
import hugOne from '../../assets/images/hugOne.png';
import hugTwo from '../../assets/images/hugTwo.png';
import hugThree from '../../assets/images/hugThree.png';
        ...
        <div className='row'>
            <div className='col-12'>
                <Carousel interval={null} prevIcon={<PrevIcon />} nextIcon={<NextIcon />}>
                    <Carousel.Item>
                        <img style={{  }} width="100%" height={650} alt="900x500" src={carouselImage1} />
                        <div className='carousel-image-absolute  ms-5'>
                            <div className='d-flex flex-column mx-5'>
                                <h2 className='text-dark font-weight-700 text-34 mb-4'>
                                    Я - <span  className='text-carousel-blue'>БАБУР АДИЛЬХАН</span><br />CEO TANU.AI
                                </h2>
                                <p className='text-dark mb-4'>“Благодаря нашей платформе я узнал особенности своих ведущих талантов:”</p>
                                <div className='row'>
                                    <div className='col-4 d-flex align-items-center bg-active-subitem px-3 mb-2'>
                                        <Image src={first} style={{width:'68px', height:'68px'}}></Image>
                                        <div className='d-flex flex-column'>
                                            <span style={{fontSize:'22px', fontWeight:'600'}} className='fw-bold'>Achiever</span>
                                            <span style={{fontSize:'12px', fontWeight:'400'}}>Достижения</span>
                                        </div>
                                    </div>
                                    <div className='col-8 mb-2'>
                                        <div className='d-flex align-items-center carousel-item-card'>
                                            ...
                                            <div className='d-flex flex-column px-3'>
                                                <span style={{fontSize:'14px', fontWeight:'400'}}className='fw-bold text-dark'>Сильные стороны</span>
                                                <span style={{fontSize:'14px', fontWeight:'400'}} className='text-dark text-subitem'>Способность работать над проектом до достижения идеального результата, несмотря на возникающие трудности</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div className='col-4 d-flex align-items-center bg-subitem px-3 mb-2'>
                                        <Image src={second} style={{width:'68px', height:'68px'}}></Image>
                                        <div className='d-flex flex-column'>
                                            <span  style={{fontSize:'22px', fontWeight:'600'}}  className='fw-bold'>Focus</span>
                                            <span style={{fontSize:'12px', fontWeight:'400'}}>Сфокусированность</span>
                                        </div>
                                    </div>
                                    <div className='col-8 mb-2'>
                                        <div className='d-flex align-items-center carousel-item-card px-2.5'>
                                            {/* <svg  width="88" height="88" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect  x="68" y="68" width="70" height="70" rx="24" transform="rotate(-180 68 68)" fill="#FF5B5B" fill-opacity="0.15" />
                                            ...
                                            <Image style={{width:'50px', height:'50px'}} src={outcome}></Image>
                                            <div className='ms-3 d-flex flex-column'>
                                                <span style={{fontSize:'14px', fontWeight:'400'}} className='fw-bold text-dark'>Подводные камни</span>
                                                <span style={{fontSize:'14px', fontWeight:'400'}} className='text-dark text-subitem'>Ваши основные силы в этой области связаны с упорством, целеустремленностью. Однако, это может привести к перегрузке работой и как следствие к усталости и стрессу.</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div className='col-4 d-flex align-items-center bg-subitem-warning px-3 mb-2'>
                                        <Image src={third} style={{width:'68px', height:'68px'}}></Image>
                                        <div className='d-flex flex-column'>
                                            <span style={{fontSize:'22px', fontWeight:'600'}}  className='fw-bold'>Competition</span>
                                            <span style={{fontSize:'12px', fontWeight:'400'}}>Конкуренция</span>
                                        </div>
                                    </div>
                                    <div className='col-8 mb-2'>
                                        <div className='d-flex align-items-center carousel-item-card'>
                    ...
                    <Carousel.Item>
                        <img style={{ position: 'relative' }} width="100%" height={650} alt="900x500" src={carouselImage1} />
                        <div className='carousel-image-absolute'>
                            <div className='d-flex flex-column mx-5 '>
                                <h2 className='text-dark font-weight-700 mb-4 ms-5'>
                                    Я - <span className='text-carousel-blue'>АЛЕКС ЕВДОКИМОВ</span><br />CPO TANU.AI
                                </h2>
                                <p className='text-dark mb-4 ms-5'>“Наш проект помог мне узнать о себе такие вещи как: “</p>
                                <div className='row '>
                                    <div className='col-10 ms-5 mb-2 '  >
                                        <div className='d-flex carousel-item-card'>
                                            <Image style={{width:'30px', height:'30px', marginTop:'5px', marginRight:'15px'}} src={hugOne}></Image>
                                            <div className='d-flex flex-column'>
                                    ...
                                    <div className='col-10 ms-5 mb-2'>
                                        <div className='d-flex  carousel-item-card'>
                                            <Image style={{width:'30px', height:'30px', marginTop:'5px', marginRight:'15px'}} src={hugTwo}></Image>
                                            <div className='d-flex flex-column'>
                                    ...
                                    <div className='col-10 ms-5 mb-2'>
                                        <div className='d-flex  carousel-item-card'>
                                            <Image style={{width:'30px', height:'30px', marginTop:'5px', marginRight:'15px'}} src={hugThree}></Image>
                                            <div className='d-flex flex-column'>
                            ...
                            <img className='img-fluid ' style={{marginRight:'250px'}} width={'50%'} alt="900x500" src={carouselImage2Img} />
                        </div>
                    </Carousel.Item>
                    <Carousel.Item>
                        <img style={{ position: 'relative' }} width="100%" height={650} alt="900x500" src={carouselImage1} />
                        <div className='carousel-image-absolute ms-5'>
                            <div className='d-flex flex-column mx-5'>
                                <h2 className='text-dark font-weight-700 mb-4'>
                                    Я - <span className='text-carousel-blue '>КАБДИЕВ АСЕТ</span><br />CTO TANU.AI
                                </h2>
                                <p className='text-dark mb-4 '>“3 профессии, которые мне подобрали специалисты”</p>
                                <div className='row'>
                                    <div>
                                        <div ></div>
                                    </div>
                            ...
                            <img className='img-fluid' width={'40%'} alt="900x500" src={carouselImage3Img} />
                        </div>
                    </Carousel.Item>
                </Carousel>
            </div>
